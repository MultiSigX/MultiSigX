...
<p>Attached <strong>MultiSigX.com-<?=$compact['data']['name']?>-MSX-Print-<?=$compact['data']['i']?>.pdf</strong> file is a copy of your MultiSigX&#8482;. This is a password protected document. The password is the six numbers in the name, a minus sign and the first six digits of the coin name [<?=substr($compact['data']['address'],0,6)?>]. It contains the encrypted keys used to secure your MultiSigX <?=$compact['data']['currencyName']?> <?=$compact['data']['currency']?> wallets. You must keep this email in your records for safe keeping. Because it is encrypted with your passcode, and because we do not have a copy of your passcode, forgetting the passcode used with your accounts will result in loss of your <?=$compact['data']['currencyName']?>. You may want to print the attached file and store it in a safe place. </p>
