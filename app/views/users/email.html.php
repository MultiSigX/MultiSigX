...
<?php echo $msg;?>
<?=$this->form->create("",array('url'=>'/users/confirm/','class'=>'form-group has-error')); ?>
<?=$this->form->field('email', array('label'=>'Email','placeholder'=>'name@youremail.com','class'=>'form-control' )); ?><br>
